...
public class ApprovalOutboxHelper {
    ...
    @Transactional(readOnly = true)
    public Optional<List<OrderApprovalOutboxMessage>> getApprovalOutboxMessageBySagaIdAndSagaStatus(
    ...
    public void save(OrderApprovalOutboxMessage orderApprovalOutboxMessage){
        ...
        log.info("OrderApprovalOutboxMessage saved with order id: {}", orderApprovalOutboxMessage.getId());
    }
