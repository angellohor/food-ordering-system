...
public class OrderApplicationServiceTest {
    ...
    private final UUID PRODUCT_ID = UUID.fromString("d215b5f8-0249-4dc5-89a3-51fd148c231");
    private final UUID ORDER_ID = UUID.fromString("d215b5f8-0249-4dc5-89a3-51fd148c2d45");
    ...
    public void testCreateOrderWithWrongTotalPrice(){
        ...
        assertEquals("Total price: 300.00 is not equal to Order items total: 200.00!", orderDomainException.getMessage());
    }
    ...
    @Test
    public void testCreateWithPassiveRestaurant(){
        Restaurant restaurantResponse = Restaurant.builder()
                .restaurantId(new RestaurantId(createOrderCommand.getRestaurantId()))
                .products(List.of(new Product(new ProductId(PRODUCT_ID), "product-1",
                                new Money(new BigDecimal("50.00"))),
